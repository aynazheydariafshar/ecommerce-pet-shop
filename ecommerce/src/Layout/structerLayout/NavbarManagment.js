...
export default function NavbarManagment() {
  ...
  const renderMobileMenu = (
    ...
    >
      ...
      <MenuItem>
        <Button onClick={handleLogOut} className="btn-color">
          {" "}
          خروج
        </Button>
      </MenuItem>
  ...
  return (
    <Box sx={{ flexGrow: 1 }}>
      <AppBar
        position="static"
        sx={{ backgroundColor: "#F8F9FD", color: "black" }}
      >
        <Box sx={{ display: "flex", alignItems: "center" }}>
          ...
          >
            ...
            <Link to="/inventory" className="link">
              <Stack direction="row" spacing={2}>
                <Button className="icon-navbar btn-color">
                  موجودی و قیمت ها
                </Button>
              </Stack>
            </Link>
            <Link to="/management-productes" className="link">
              <Stack direction="row" spacing={2}>
                <Button className="icon-navbar btn-color" sx={{ mr: "70px" }}>
                  کالاها
                </Button>
              </Stack>
            </Link>
